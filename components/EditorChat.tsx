...
const EditorChat = () => {
  return (
    <div className="chat-cover w-full flex flex-col gap-8">
    ...
    <div className=" w-full bg-[#0c1526] h-auto rounded-xl overflow-hidden pt-2">
      ...
      <div className="py-4 px-4" id="message">
        ...
        <div className="flex bg-[#11203d] py-3 px-3 rounded-lg mt-2">
          <h2 className="text-white">
            Yeah, sure. I was thinking about adding live comment feature
            to the application, what do you think about it? Do you have
            any other ideas which we can implement?
          </h2>
        </div>
      </div>
